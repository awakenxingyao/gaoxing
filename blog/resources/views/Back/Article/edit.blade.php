    ...
    <aside class="right-side">
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        <form action="{{route('articleUpdate', ['id'=>$article->id])}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subject" value="{{old('subject', $article->subject)}}" placeholder="标题" id="input-subject" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    @if($errors->has('cover'))
                                        <label for="input-cover" class="text-danger">{{$errors->first('cover')}}</label>
                                    @endif
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="summary" placeholder="摘要" id="input-summary" class="form-control">{{old('summary', $article->summary)}}</textarea>
                                </div>

                                <div class="form-group">
                                    <label for="input-content">内容</label>
                                    <textarea name="content" placeholder="内容" id="input-content" class="form-control">{{old('content', $article->content)}}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @if($errors->has('category_id'))
                                        <label for="input-subject" class="text-danger">{{$errors->first('category_id')}}</label>
                                    @endif
                                </div>
